      ...
      <View style={{ flexDirection: "row" }}>
        <View style={styles.addedView}>
          <View style={styles.profileSection}>
            {item.profile_thumb === 'https://pngimage.net/wp-content/uploads/2018/06/user-png-image-5.png' ? (
              <Image
                source={{uri: `${item.profile_thumb}`}}
                style={styles.img}
              />
            ) : (
              <Image
            ...
            {added === false ? (
              ...
              <TouchableOpacity onPress={this.addPerson}>
                <View style={styles.addFunds2}>
                  <TextView style={styles.addFundsBtn} text='Added'></TextView>
                </View>
              </TouchableOpacity>
            )}
