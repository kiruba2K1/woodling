...
import FindTalentsRequest from '../screens/FindTalentRequest';
import StarredTalents from '../screens/StarredTalents';
...
const FindTalentsStack = createStackNavigator(
  {
    ...
    FindTalentsRequest: {
      screen: FindTalentsRequest,
      navigationOptions: ({navigation}) => ({
        header: null,
      }),
    },
    StarredTalents: {
      screen: StarredTalents,
      navigationOptions: ({navigation}) => ({
        header: null,
      }),
    },
