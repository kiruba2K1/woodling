    ...
    return (
      <View style={{ backgroundColor: '#eeeeee', marginBottom: 20 }}>
            ...
            <Modal visible={visible} onDismiss={this.hideModal}>
              ...
              <View style={styles.modalStyle}>
                ...
                <View
                  ...
                  <TextView style={styles.title} text='COMPANY/INSTITUTE'></TextView>
                ...
                <View
                  ...
                  <View style={{ marginHorizontal: 20 }}>
                    <TextView style={styles.title} text='ROLE & ROLE TYPE'></TextView>
                    <View
                      style={{
                        flexDirection: 'row',
                        justifyContent: 'center',
                      ...
                      <View
                        ...
                        <TextView text='Producer' style={{ color: 'red' }}></TextView>
                      </View>
                      <FontAwesome5
                        name="circle"
                        solid
                  ...
                  <View>
                    <TextView style={styles.title} text='Location & Date'></TextView>
                ...
                <View style={{ flex: 5, borderBottomWidth: 1, paddingHorizontal: 40 }}>
                  <View style={{ flex: 1, alignItems: 'center' }}>
                    <TextView style={styles.title} text='Description'></TextView>
                  </View>
                  <View style={{ flex: 6 }}>
                    <ScrollView>
        ...
        <View style={styles.joinDate}>
          ...
          <TextView style={{ color: '#fb0201', fontSize: 10 }} text={`Joined since ${year}`}></TextView>
        </View>
        ...
        <View style={{ alignSelf: 'flex-end' }}>
          <View style={{ justifyContent: 'flex-end', flexDirection: 'row' }}>
            <FontAwesome5 name="pen" size={20} style={styles.iconStyle} />
            <TextView style={styles.headerStyle} text='Skills'></TextView>
          </View>
          <View
            style={{
              backgroundColor: '#ffffff',
        ...
        <View style={{ alignSelf: 'flex-start' }}>
          <View style={{ flexDirection: 'row' }}>
            <TextView style={[styles.headerStyle, { textAlign: 'center', marginLeft: 20 }]} text='Experience'>
          ...
          <View
            ...
            {data.user_experience !== '' ? (
                  ...
                  <View style={styles.singleExperience}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                      <View style={styles.experienceRole}>
                        <TextView style={{ color: '#fb0201' }} text='Producer'></TextView>
                      </View>
                      <View
                        style={{
                          width: 6,
              ...
              <TextView style={{ fontSize: 18, textAlign: 'center', fontFamily: 'Forte' }} text='No experience listed yet'>
              </TextView>
            )}
              ...
              <View
                ...
                <View style={{ flex: 1 }}>
                  <TouchableOpacity
                    ...
                    <TextView style={{ color: 'white', fontSize: 15 }} text='See all'></TextView>
                  </TouchableOpacity>
                </View>
              </View>
            )}
        ...
        <View style={{ alignSelf: 'flex-end' }}>
          ...
          <View
            ...
            <View style={[styles.personalContent, { borderBottomWidth: 0 }]}>
              ...
              <TextView text='website'></TextView>
            </View>
          </View>
        </View>
      </View>
