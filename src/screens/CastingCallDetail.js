...
class CastingCallDetail extends Component {
  ...
  componentWillMount() {
    ...
    axios
      .get(
        `${apiurl}view-casting-call-details.php?user_id=${user_id}&id=${casting_call_id}`,
      )
      .then(res => {
        ...
        <View style={{backgroundColor: '#eeeeee', flex: 1}}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerTitle}>
              <TextView style={styles.title} text="Casting Call"></TextView>
            </View>
            ...
            <View
              style={[
                ...
                {
                  backgroundColor:
                    details.data[0].created_by === user_id
                      ? '#fb0201'
                      : 'transparent',
                },
              ]}>
                ...
                <TouchableOpacity
                  onPress={() => {
                    this.props.navigation.navigate('ViewApplicants', {
                      ...
                      date_created: details.data[0].date_created,
                    });
                  }}>
                  <View
                    style={{
          ...
          {details.data[0].created_by === user_id && (
            <FAB
              ...
              icon="edit"
              onPress={() =>
                this.props.navigation.navigate('EditCastingCall', {
                  casting_call_details: details,
                })
              }
            />
          )}
          <ScrollView
            ...
            <View
              ...
              <View style={{flex: 1, alignItems: 'center'}}>
                <Text>
                  Posted:{' '}
                  {moment(
                    parseInt(`${details.data[0].date_created}`) * 1000,
                  ).fromNow()}
                </Text>
              </View>
            </View>
            ...
            <View style={{marginTop: 10, backgroundColor: '#eeeeee'}}>
              <View
                ...
                <View style={{flexDirection: 'row'}}>
                  <TextView text="Starting on:" />
                  <Text style={{color: 'black'}}>
                    {details.data[0].start_date}
                  </Text>
                </View>
                <View style={{flexDirection: 'row'}}>
                  <TextView text="Application deadline:" />
                  <Text style={{color: 'black'}}>
                    {details.data[0].deadline}
                  </Text>
                </View>
              </View>
            </View>
            <View style={{backgroundColor: '#eeeeee', marginTop: 10}}>
              <View
                ...
                <TextView style={{paddingVertical: 10}} text="DATES & VENUES" />
                <Text style={{color: 'black'}}>
                  {details.data[0].date_venue}
                </Text>
              </View>
            </View>
            <View style={{marginTop: 10, backgroundColor: '#eeeeee'}}>
