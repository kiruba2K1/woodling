    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#eeeeee' }}>
        ...
        <ScrollView>
          ...
          <View style={{ flex: 1, marginVertical: 10, paddingLeft: 20 }}>
            <TextView text='Get in Touch with' />
          </View>
          <View style={styles.cardBackground}>
            <FlatList
              horizontal
          ...
          <View style={{ flex: 1, marginVertical: 10, paddingLeft: 20 }}>
            <TextView text='Follow Interests' />
          </View>
          <View style={styles.followBackground}>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <TextView style={{ fontSize: 10, fontWeight: '700', color: 'black' }} text='See all' />
              </TouchableOpacity>
            </View>
          </View>
          <View style={{ flex: 1, marginVertical: 10, paddingLeft: 20 }}>
          ...
          <View style={styles.eventsBackground}>
            <View>
              ...
              <TextView style={{ textAlign: 'center' }} text='CONCERT' />
            </View>
            <View>
              <TouchableOpacity
                style={styles.imageStyle}
              ...
              <TextView style={{ textAlign: 'center' }} text='DRAMAS/PLAYS' />
            </View>
            <View>
              <TouchableOpacity
                style={styles.imageStyle}
              ...
              <TextView style={{ textAlign: 'center' }} text='SHOWS' />
            </View>
            <View>
              <TouchableOpacity
                style={styles.imageStyle}
              ...
              <TextView style={{ textAlign: 'center' }} text='PARTIES' />
            </View>
          </View>
        </ScrollView>
      </View>
