    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView>
          ...
          <View style={styles.range2}>
            <View
              ...
              <View
                ...
                <Dropdown
                  containerStyle={{flex: 1, marginTop: -24, minWidth: 150}}
                  label="Production Type"
                  data={productiontype}
                  valueExtractor={({name}) => name}
                  onChangeText={(value, index, data) => {
                    const {id} = data.find(val => val.name === value);
                    this.setState({production_type_id: id});
                  }}
                />
              </View>
            </View>
          ...
          <View style={styles.range2}>
            <RadioButton.Group
              onValueChange={production_type_id =>
                this.setState({production_type_id})
              }
              value={production_type_id}>
              <View
               style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-evenly',alignItems:"center" }}
              >
                <View style={{alignItems: 'center',flex:1,justifyContent:"center"}}>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <RadioButton
           ...
           // onPress={() => { this.setState({ checked: 'first' }); }}
                ...
                <View style={{flexDirection: 'row',alignItems: 'center',flex:1,justifyContent:"center",marginEnd:20}}>
          <RadioButton
            // value="first"
            // status={this.state.checked != 'first' ? 'checked' : 'unchecked'}
            // onPress={() => { this.setState({ checked: 'second' }); }}
          />
        <Dropdown containerStyle={{flex:1, marginTop: -24,minWidth:150}}
       label='Role'
       data={skills.data}
     />
        </View>
