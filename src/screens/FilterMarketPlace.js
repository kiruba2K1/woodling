      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerTitle}>
            <TextView style={styles.title} text='Filter Market Place' />
          </View>
          <View>
        ...
        <View style={{ padding: 10 }}>
          <TextView style={{ fontSize: 16, fontFamily: 'Poppins-Medium' }} text='Location' />
        </View>
        <View style={styles.catSearch}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 10 }}>
            ...
            <TextView style={{ fontSize: 13, fontFamily: 'Poppins-Medium' }} text='Worldwide' />
          </View>
        </View>
        <View style={{ padding: 10 }}>
          <TextView style={{ fontSize: 16, fontFamily: 'Poppins-Medium' }} text='Price Range' />
        </View>
        <View style={styles.price}>
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <TextView style={{ fontSize: 13, fontFamily: 'Poppins-Medium' }} text='Min' />
          ...
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <TextView style={{ fontSize: 13, fontFamily: 'Poppins-Medium' }} text='Max' />
            <View style={styles.priceMin}>
              <TextInput
                value={max_price}
