      ...
      <ScrollView
          ...
          <Modal visible={visible} onDismiss={this.hideModal}>
            <View style={styles.modalStyle}>
              ...
              <View style={{alignItems: 'center'}}>
                <TextView style={{color: 'black', fontSize: 20, fontWeight: 'bold'}} text='Add Skill' />
              </View>
              <View>
                <TextInput
              ...
              <View style={{alignItems: 'flex-end'}}>
                <TouchableOpacity
                  ...
                  <TextView style={{fontSize: 15, color: 'white'}} text='ENTER' />
                </TouchableOpacity>
              </View>
            </View>
          </Modal>
        ...
        <View style={{flex: 1}}>
          ...
          <View
            ...
            <TextView style={{fontSize: 20, color: 'black'}} text='Setup' />
            <TextView style={{fontSize: 20, color: 'black', fontWeight: 'bold'}} text='Choose Your Skill' />
            <TextView style={{fontSize: 15, color: 'black'}} text='(Pick up to 5)' />
          ...
          <View style={styles.bottomContainer}>
            <View style={{flex: 1}}>
              <View style={{marginLeft: 20, marginHorizontal: 10}}>
                <TextView text={`skills selected (${selected.length})`} />
              </View>
            ...
            <View style={{flex: 1.5}}>
              ...
              <View style={{position: 'absolute', right: 0, bottom: 60}}>
                <TouchableOpacity
                  ...
                  <TextView style={{color: 'white'}} text={selected.length !== 0 ? 'NEXT ' : 'SKIP '} />
