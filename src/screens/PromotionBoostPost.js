  ...
  render() {
    ...
    return (
      ...
      <Modal
        ...
        <TextView style={styles.textBoost} text='Target the right audience for each post to ensure max engagement.' />
        </View>
        </View>
        ...
        <View style={styles.text2}>
        <TextView style={styles.textBoost} text='View insights for your promoted posts to analyse engagement and have a better understanding of your audience.' />
<View style={styles.text3}>
<TextView style={styles.textBlue} text='Learn more about this in our FAQ.' />
</View>
        </View>
        </View>
