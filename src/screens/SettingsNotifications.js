        ...
        <View style={styles.container}>
          <View style={styles.header}>
            ...
            <View style={styles.headerTitle}>
              <TextView style={styles.title} text='Setting > Notifications' />
            </View>
          </View>

          <ScrollView>
            <View style={styles.greyComponent}>
              <TextView style={styles.greyText} text='Activity Stream' />
            </View>

            <View style={styles.activeComponent}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Post Like' />
                <TextView style={styles.activeText2} text='Get notified when someone likes your post' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.activeComponent}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Post Comment' />
                <TextView style={styles.activeText2} text='Get notified when someone comments your post' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.activeComponent}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Share' />
                <TextView style={styles.activeText2} text='Get notified when someone shares your post' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.activeComponent2}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Comment Like & Reply'/>
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.greyComponent}>
              <TextView style={styles.greyText} text='Messages ' />
            </View>

            <View style={styles.activeComponent3}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Message Notification' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.greyComponent}>
              <TextView style={styles.greyText} text='Connect' />
            </View>

            <View style={styles.activeComponent3}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Requests' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.activeComponent3}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Follows' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.activeComponent3}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Ratings' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
            ...
            <View style={styles.greyComponent}>
              <TextView style={styles.greyText} text='Email Notifications' />
            </View>

            <View style={styles.activeComponent4}>
              <View style={styles.wrapper}>
                <TextView style={styles.verifyText} text='Subscribe' />
              </View>
              <View style={{ flex: 1 }}>
                <Switch
