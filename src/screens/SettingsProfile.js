...
class SettingsProfile extends Component {
  ...
  componentDidMount() {
    ...
    axios
      ...
      .then(res => {
        ...
        const date = res.data.data.date_of_birth;
        const newdate = date.split('-');
        this.setState({ day: newdate[0] });
        this.setState({ month: newdate[1] });
        this.setState({ year: newdate[2] });
  ...
  birthdayDisplay = value => {
    ...
    if (value === false) {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=birthday_display&value=0`,
        )
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=birthday_display&value=1`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    }
  ...
  locationDisplay = value => {
    ...
    if (value === false) {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=location_display&value=0`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    } else {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=location_display&value=1`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    }
  ...
  genderDisplay = value => {
    ...
    if (value === false) {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=gender_display&value=0`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    } else {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=gender_display&value=1`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    }
  ...
  emailDisplay = value => {
    ...
    if (value === false) {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=email_display&value=0`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    } else {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=email_display&value=1`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    }
  ...
  phoneDisplay = value => {
    ...
    if (value === false) {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=phone_display&value=0`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    } else {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=phone_display&value=1`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    }
  ...
  websiteDisplay = value => {
    ...
    if (value === false) {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=website_display&value=0`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    } else {
      ...
      axios
        .get(
          `${apiurl}update-setting-profile.php?user_id=${user_id}&type=website_display&value=1`,
        )
        .then(res => console.log(res.data))
        .catch(res => console.log(res.data));
    }
  ...
  fromGallery = () => {
    ...
    ImagePicker.openPicker({
      ...
      .then(image => {
        ...
        axios
          .post(
            `${apiurl}update-setting-profile.php?user_id=${user_id}&type=${type}`,
            body,
          )
          .then(res => {
  ...
  onSave = async () => {
    ...
    if (day === '' || month === '') {
      return alert('day and month fileds are required');
    }
    const body = new FormData();
        ...
        <View style={styles.container}>
          ...
          <SafeAreaView>
            <View style={styles.header}>
              ...
              <TextView style={styles.title} text='Setting > Profile' />
              <TouchableOpacity
          ...
          <ScrollView>
            <TouchableOpacity
              style={styles.imageBgprofile}
              onPress={() =>
                this.setState({ pickerVisible: true, type: 'cover_photo' })
              }>
              <Image
                style={{ height: 407, width }}
                source={
                  cover_photo === null
            ...
            <View style={styles.profileEdit}>
              ...
              <TextView style={styles.smallTitles} text='Name' />
            </View>
            ...
            <View style={styles.profileEditToggleWrapper}>
              ...
              <View style={styles.profileEditToggle}>
                <TextView style={styles.toggleText} text='Birthday' />
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
                  }}>
                  <TextView style={styles.toggleText2} text='Display on Profile' />
            ...
            <View style={styles.profileEditToggleWrapper}>
              ...
              <View style={styles.profileEditToggle}>
                <TextView style={styles.toggleText} text='Location' />
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
            ...
            <View style={styles.profileEditToggleWrapper}>
              ...
              <View style={styles.profileEditToggle}>
                <TextView style={styles.toggleText} text='Gender' />
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
            ...
            <View style={styles.profileEditToggleWrapper}>
              ...
              <View style={styles.profileEditToggle}>
                <TextView style={styles.toggleText} text='Marital Status' />
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
            ...
            <View style={styles.profileEditToggleWrapper}>
              ...
              <View style={styles.profileEditToggle}>
                <TextView style={styles.toggleText} text='Email' />
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
            ...
            <View style={styles.profileEditToggleWrapper}>
              ...
              <View style={styles.profileEditToggle}>
                <TextView style={styles.toggleText} text='Phone Number' />
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
            ...
            <View style={styles.profileEditToggleWrapper}>
              ...
              <View style={styles.profileEditToggle}>
                <TextView style={styles.toggleText} text='Website' />
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
            ...
            <View style={styles.editBio}>
              <View style={styles.profileEditToggleWrapper}>
                ...
                <View style={styles.profileEditToggle}>
                  <TextView style={styles.toggleText} text='Edit Bio' />
                  <View
                    style={{
                      flexDirection: 'row',
                      justifyContent: 'space-between',
                    }}>
                    <TextView style={{ fontFamily: 'Poppins-Medium', fontSize: 9 }} text='180 characters' />
                  </View>
                </View>
              </View>
              <View style={styles.editFieldContainer}>
            ...
            <View style={styles.editSkills}>
              <View style={styles.profileEditToggleWrapper}>
                ...
                <View style={styles.profileEditToggle}>
                  <TextView style={styles.toggleText} text='Edit Skills' />
                </View>
              </View>
              ...
              <View style={{ justifyContent: 'flex-end', flexDirection: 'row' }}>
                {data.user_roles === '' && (
                  <View style={styles.curvedView}>
                    <TextView style={{ fontSize: 20, fontFamily: 'Poppins-Medium' }} text='You have not selected any roles' />
                  </View>
                )}
                {data.user_roles !== '' && (
                  <View style={styles.curvedView}>
              ...
              <View
                ...
                <View
                  ...
                  <Text
                    ...
                    onPress={() =>
                      this.props.navigation.navigate('SettingsExperience')
                    }>
                    + Add
                  </Text>
                </View>
                  ...
                  <View>
                    <TextView
                      style={{
                        ...
                        fontStyle: 'italic',
                        textAlign: 'center',
                      }} text='No experience has been added yet' />
                  </View>
                )}
                {data.user_experience !== '' && (
                  <View>
                    {data.user_experience.map(e => (
                      <View
                        ...
                        <Text style={styles.experienceCurveContainerText}>
                          {e.company}
                        </Text>
