...
export class SetupRolesBusiness extends Component {
  ...
  onDone() {
    ...
    axios
      .post(
        apiurl + 'update-user-setup-details.php',
        body
      )
      ...
      return (
        <View style={{ flex: 1, backgroundColor: '#f1f1f1' }}>
          <View style={{ flex: 2, alignItems: 'center', justifyContent: 'center' }}>
            <TextView style={{ color: 'black', fontSize: 20 }} text='Setup' />
            <TextView style={{ color: 'black', fontSize: 20, fontWeight: 'bold' }} text='Tell Us About Your Business' />
            <TextView text='(You may pick multiple options)' />
          </View>
          ...
          <TouchableOpacity
            ...
            <TextView style={{ color: 'white' }} text='Done' />
