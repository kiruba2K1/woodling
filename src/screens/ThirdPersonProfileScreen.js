          ...
          <Animated.View
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <TextView style={{ fontSize: 20, paddingBottom: 10 }} text='About' />
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <TextView style={{ fontSize: 20, textAlign: 'center' }} text='Activity' />
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <TextView style={{ fontSize: 20, textAlign: 'center' }} text='Ratings' />
              </TouchableOpacity>
              <TouchableOpacity
                ...
                <TextView style={{ fontSize: 20, textAlign: 'center' }} text='People' />
              </TouchableOpacity>
            </View>
          </Animated.View>
          <ScrollView
